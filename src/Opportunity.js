...
const Opportunity = () => {
    ...
    return ( 
        <div>
            <h1 style={{color: 'white', textAlign: 'center', marginBottom: '100px'}} >This is Opportunity page</h1>
            ...
            {data && <p style={{padding: '30px', textAlign: 'center', color: 'white'}} >Here are Opportunity photos on sol {sol} taken with {camera} camera, if it's loading no photos, choose another camera or sol</p>}
