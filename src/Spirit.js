...
const Spirit = () => {
    ...
    return ( 
        <div>
            <h1 style={{color: 'white', textAlign: 'center', marginBottom: '50px'}} >This is Spirit page</h1>
            ...
            {data && <p style={{padding: '30px', textAlign: 'center', color: 'white'}} >
                        Here are Spirit photos on sol {sol} taken with {camera} camera, if it's loading no photos, choose another camera or sol
                    </p>
            }
